...
$db->Execute(
    "CREATE TABLE IF NOT EXISTS " . TABLE_PRODUCTS_LOCATION . " 
        (
...
$db->Execute(
    "INSERT  IGNORE INTO " . TABLE_PRODUCTS_LOCATION . " (products_id, products_location)
...
$sort_order = [
    [
        'configuration_group_id' => ['value' => $configuration_group_id, 'type' => 'integer'],
        'configuration_key' => ['value' => $module_constant . '_PLUGIN_CHECK', 'type' => 'string'],
        'configuration_title' => ['value' => $module_name . ' (Update Check)', 'type' => 'string'],
        'configuration_value' => ['value' => SHOW_VERSION_UPDATE_IN_HEADER, 'type' => 'string'],
        'configuration_description' => ['value' => 'Allow version checking if Zen Cart version checking enabled<br/><br/>If false, no version checking performed.<br/>If true, then only if Zen Cart version checking is on:',
            'type' => 'string'],
        'date_added' => ['value' => 'NOW()', 'type' => 'noquotestring'],
        'use_function' => ['value' => 'NULL', 'type' => 'noquotestring'],
        'set_function' => ['value' => 'zen_cfg_select_option([\'true\', \'false\'],', 'type' => 'string'],
    ],
    [
        'configuration_group_id' => ['value' => $configuration_group_id, 'type' => 'integer'],
        'configuration_key' => ['value' => $module_constant . '_VERSION', 'type' => 'string'],
        'configuration_title' => ['value' => $module_name . '<b> Version</b>', 'type' => 'string'],
        'configuration_value' => ['value' => '0.0.0', 'type' => 'string'],
        'configuration_description' => ['value' => $module_name . ' Version', 'type' => 'string'],
        'date_added' => ['value' => 'NOW()', 'type' => 'noquotestring'],
        'use_function' => ['value' => 'NULL', 'type' => 'noquotestring'],
        'set_function' => ['value' => 'zen_cfg_select_option([\'0.0.0\'],', 'type' => 'string'],
    ],
    [
        'configuration_group_id' => ['value' => $configuration_group_id, 'type' => 'integer'],
        'configuration_key' => ['value' => 'PRODUCTS_LOCATION_PACKING_DISPLAY', 'type' => 'string'],
        'configuration_title' => ['value' => 'Display location on Packing Slip', 'type' => 'string'],
        'configuration_value' => ['value' => 'true', 'type' => 'string'],
        'configuration_description' => ['value' => '<br />If true, the products location will be displayed on the Packing Slip.<br /><b>Default: true</b>',
            'type' => 'string'],
        'date_added' => ['value' => 'NOW()', 'type' => 'noquotestring'],
        'use_function' => ['value' => 'NULL', 'type' => 'noquotestring'],
        'set_function' => ['value' => 'zen_cfg_select_option([\'true\', \'false\'],', 'type' => 'string'],
    ...
    [
        'configuration_group_id' => ['value' => $configuration_group_id, 'type' => 'integer'],
        'configuration_key' => ['value' => 'PRODUCTS_LOCATION_INVOICE_DISPLAY', 'type' => 'string'],
        'configuration_title' => ['value' => 'Display location on invoice', 'type' => 'string'],
        'configuration_value' => ['value' => 'true', 'type' => 'string'],
        'configuration_description' => ['value' => '<br />If true, the products location will be displayed on the invoice.<br /><b>Default: true</b>',
            'type' => 'string'],
        'date_added' => ['value' => 'NOW()', 'type' => 'noquotestring'],
        'use_function' => ['value' => 'NULL', 'type' => 'noquotestring'],
        'set_function' => ['value' => 'zen_cfg_select_option([\'true\', \'false\'],', 'type' => 'string'],
    ...
    [
        'configuration_group_id' => ['value' => $configuration_group_id, 'type' => 'integer'],
        'configuration_key' => ['value' => 'PRODUCTS_LOCATION_CATEGORY_DISPLAY', 'type' => 'string'],
        'configuration_title' => ['value' => 'Display location on catalog products category', 'type' => 'string'],
        'configuration_value' => ['value' => 'true', 'type' => 'string'],
        'configuration_description' => ['value' => '<br />If true, the products location will be displayed on the catalog products categories display when desplaying lists of products.<br /><b>Default: true</b>',
            'type' => 'string'],
        'date_added' => ['value' => 'NOW()', 'type' => 'noquotestring'],
        'use_function' => ['value' => 'NULL', 'type' => 'noquotestring'],
        'set_function' => ['value' => 'zen_cfg_select_option([\'true\', \'false\'],', 'type' => 'string'],
    ...
    [
        'configuration_group_id' => ['value' => $configuration_group_id, 'type' => 'integer'],
        'configuration_key' => ['value' => 'PRODUCTS_LOCATION_SORT_DISPLAY', 'type' => 'string'],
        'configuration_title' => ['value' => 'Sort Invoice and packing slipt by location', 'type' => 'string'],
        'configuration_value' => ['value' => 'true', 'type' => 'string'],
        'configuration_description' => ['value' => '<br>If true, the Invoice and the Picking list will be sorted by products location.<br><b>Default: true</b>',
            'type' => 'string'],
        'date_added' => ['value' => 'NOW()', 'type' => 'noquotestring'],
        'use_function' => ['value' => 'NULL', 'type' => 'noquotestring'],
        'set_function' => ['value' => 'zen_cfg_select_option([\'true\', \'false\'],', 'type' => 'string'],
