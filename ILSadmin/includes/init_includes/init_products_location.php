...
if (isset ( $_SESSION ['admin_id'] )) {
	$module_constant = 'PRODUCTS_LOCATION'; // This should be a UNIQUE name followed by _VERSION for convention
	$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/products_location'; // This is the directory your installer is in, usually this is lower case
	$module_name = 'Product Location'; // This should be a plain English or Other in a user friendly way
	$admin_page = 'ProductLocation';
	$module_file_for_version_check = 'categories.php'; // File to check for new version so it doesn't check on every page
