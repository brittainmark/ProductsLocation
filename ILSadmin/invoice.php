        ...
        <thead>
          <tr class="dataTableHeadingRow">
            ...
            <th class="dataTableHeadingContent"><?php echo TABLE_HEADING_PRODUCTS_MODEL; ?></th>
              <?php
/*
 * BOF - Product location heading column
 */
                if (defined('PRODUCTS_LOCATION_INVOICE_DISPLAY') && PRODUCTS_LOCATION_INVOICE_DISPLAY == 'true') {
              ?>
            <th class="dataTableHeadingContent text-left"><?php echo TABLE_HEADING_LOCATION; ?></th>
              <?php
                }
/*
...
<?php } ?>
        ...
        <tbody>
            ...
            <tr class="dataTableRow">
              ...
              <?php
              /*
               * BOF - Product location display products location
               */
              if (defined('PRODUCTS_LOCATION_INVOICE_DISPLAY') && PRODUCTS_LOCATION_INVOICE_DISPLAY == 'true') {
                  ?>
