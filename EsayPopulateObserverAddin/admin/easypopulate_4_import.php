...
// From: mc12345678: I have no idea why this is necessary or what it is preventing.
//  The remaining code of the plugin should address whatever is being addressed.
        	switch ($thisvar) {
        		case 'v_field':
        		case 'v_artists_image':
        		case 'v_artists_name':
        		case 'v_artists_url':
        		case 'v_categories_name':
        		case 'v_manufacturers_name':
        		case 'v_manufacturers_url':
        		case 'v_map_enabled':
        		case 'v_metatags_description':
        		case 'v_metatags_keywords':
        		case 'v_metatags_title':
        		case 'v_music_genre_name':
        		case 'v_products_exclusive':
        		case 'v_products_gpc':
        		case 'v_products_image':
        		case 'v_products_location':
        		case 'v_products_model':
        		case 'v_products_upc':
        		case 'v_record_company_image':
        		case 'v_record_company_name':
        		case 'v_record_company_url':
        		case 'v_v_products_description':
        		case 'v_v_products_name':
        		case 'v_v_products_short_desc':
        		case 'v_v_products_url':
        		case 'v_value':
          			${$thisvar} = '';
          			break;
        		case 'v_date_added':
        		case 'v_date_avail':
        		case 'v_specials_date_avail':
        		case 'v_specials_expires_date':
        			${$thisvar} = '0001-01-01';
        			break;
        		default:
        			${$thisvar} = 0;
...
//        if ($ep_supported_mods['ploc'] == true) { // Products Location Mod
//        	$sql .= 'pl.products_location as v_products_location,';
//        }
        ...
        $sql .= 'p.products_weight      as v_products_weight,
                ...
                TABLE_PRODUCTS . " as p ";
//                if ($ep_supported_mods['ploc'] == true) { // Products Location Mod
//                	$sql .= ', '. TABLE_PRODUCTS_LOCATION.' as pl ';
//                }
...
//        if ($ep_supported_mods['ploc'] == true) { // Products Location Mod
//        	$sql .= ' AND  pl.products_id = p.products_id';
//        }
...
// mc12345678, new item need to address products_id assignment as it is provided
            ...
            if ($result == true) {
    					...
    					//Products location
/*    					if ($ep_supported_mods['ploc'] == true) { // Products Location Mod
    						$plquery = 'INSERT INTO '.TABLE_PRODUCTS_LOCATION.' SET
    							products_id			= :products_id: ,
    							products_location	= :products_location: ';
    						$plquery = $db->bindVars($plquery, ':products_id:', $v_products_id, 'integer');
    						$plquery = $db->bindVars($plquery, ':products_location:', $v_products_location, 'string');
