...
<?php if (defined('VS_PRODUCTS_LOCATION_CATEGORY_DISPLAY') && VS_PRODUCTS_LOCATION_CATEGORY_DISPLAY == 'true') {
/*
 * BOF Very Simple Product Location
 */
       ?>
                <th class="text-right hidden-sm hidden-xs"><?php echo TABLE_HEADING_VS_LOCATION;?></th><?php
}
/*
...
// Get parent_id for subcategories if search
            ...
            /*
             * BOF Very Simple Product Location
             * Add product location to select
             */
            if (defined('VS_PRODUCTS_LOCATION_CATEGORY_DISPLAY') && VS_PRODUCTS_LOCATION_CATEGORY_DISPLAY == 'true') {
              $products_query_raw = "SELECT p.products_type, p.products_id, pd.products_name, p.products_quantity,
                                          ...
                                          p.master_categories_id, pl.vs_products_location
                                     FROM " . TABLE_PRODUCTS . " p
                                     LEFT JOIN " . TABLE_PRODUCTS_DESCRIPTION . " pd ON (pd.products_id = p.products_id)
                                     LEFT JOIN " . TABLE_VS_PRODUCTS_LOCATION . " pl ON (p.products_id = pl.products_id)";
            } else {
              $products_query_raw = "SELECT p.products_type, p.products_id, pd.products_name, p.products_quantity,
                                            p.products_price, p.products_status, p.products_model, p.products_sort_order,
...
// Get categories_id for product if search
              ...
              <tr class="product-listing-row" data-pid="<?php echo $product['products_id']; ?>">
                ...
                <?php
/*
 * BOF Very Simple Product Location Display product location
 */
                if (defined('VS_PRODUCTS_LOCATION_CATEGORY_DISPLAY') && VS_PRODUCTS_LOCATION_CATEGORY_DISPLAY == 'true') {
       ?>
                <td class="text-right hidden-sm hidden-xs"><?php echo $products->fields['vs_products_location']; ?></td> <?php
              }
/*
 * EOF Very Simple Product Location
 */
