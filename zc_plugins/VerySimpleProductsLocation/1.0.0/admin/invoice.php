        ...
        <thead>
          <tr class="dataTableHeadingRow">
            ...
            <th class="dataTableHeadingContent"><?php echo TABLE_HEADING_PRODUCTS_MODEL; ?></th>
              <?php
/*
 * BOF - Very Simple Product location heading column
 */
              if (defined('VS_PRODUCTS_LOCATION_INVOICE_DISPLAY') && VS_PRODUCTS_LOCATION_INVOICE_DISPLAY == 'true') {
              ?>
            <th class="dataTableHeadingContent text-left"><?php echo TABLE_HEADING_VS_LOCATION; ?></th>
              <?php
                }
/*
...
<?php } ?>
        ...
        <tbody>
            ...
            /*
             *   BOF - Very Simple Product location
             */
            if (defined('VS_PRODUCTS_LOCATION_INVOICE_DISPLAY') && VS_PRODUCTS_LOCATION_INVOICE_DISPLAY == 'true') {
                ...
                if (VS_PRODUCTS_LOCATION_SORT_DISPLAY == 'true') $vs_products_location_sort = array_multisort(array_column($vs_products_location, 'location'), SORT_ASC, array_column($vs_products_location, 'model'), SORT_ASC, $vs_products_location);
            }
            ...
            <tr class="dataTableRow">
              ...
              <?php
              /*
               * BOF - Very Simple Product location display products location
               */
              if (defined('VS_PRODUCTS_LOCATION_INVOICE_DISPLAY') && VS_PRODUCTS_LOCATION_INVOICE_DISPLAY == 'true') {
                  ?>
